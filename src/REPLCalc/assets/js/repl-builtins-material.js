export function attachMaterialBuiltins(baseFns, {
  ...
  baseFns.material = defFnCtx("material", 2, (ctx, name, propsRaw) => {
  ...
  baseFns.density = defFn("density", 1, (mat) => {
